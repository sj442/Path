    ...
    [UIView animateWithDuration:0.3
                     ...
                     animations:^{
                         ...
                         if (hidden) {
                             ...
                             double customAlpha = 1.0;
                             [_pickerViewContainerView setAlpha:customAlpha];
...
-(void)initializePickerViewInView: (UIView *)view
    ...
    _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - customHeight, 320.0, customHeight)];
    
    //Default Color Values (if colors == nil)
    
    //PickerViewBackgroundColor - White
    if (pickerViewBackgroundColor==nil) {
        pickerViewBackgroundColor = [UIColor lightGrayColor];
    }
    ...
    //UITapGestureRecognizer *blockTap = [[UITapGestureRecognizer alloc] initWithTarget:nil action:nil];
    //[_pickerContainerView addGestureRecognizer:blockTap];
    ...
    //[_pickerTopBarView setUserInteractionEnabled:YES];
    ...
    //Add pickerView
    double customY = 35.0;
    _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0, customY, 320.0, 216.0)];
